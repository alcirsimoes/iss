...
class DirectController extends Controller
{
    ...
    private function current(Request $request, Question $question)
    {
        ...
        if ($request->input('init')){
            ...
            return ['question' => $question, 'questions' => $question->questions, 'hide' => false];
        }
    ...
    public function next(Request $request)
    {
        ...
        if (Route::currentRouteName() == 'direct.next' && !$this->store($request)){
        ...
        return view('direct.next', compact('survey','sample','subject','previous','questions','question','hide','options','suboptions','answer','checked_ids','text_values'));
    }
